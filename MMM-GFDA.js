	...
	defaults: {
		advice: {
			anytime: [
					...
					"Drink more fucking caffeine.",
					"Drink less fucking caffeine.",
					...
					"The icons need to make fucking sense",
					"Be a fucking rainbow in someone's cloud",
					"Never ruin an apology with a fucking excuse",
					"Make it worth the fucking effort",
					"Adapt what is fucking useful",
					"Reject what is fucking useless",
					"Use the fucking color wheel",
					"Thrive where others fucking fail.",
					"Self-consciousness fucking kills communication",
					"Delight your fucking audience.",
					"Fall in love with your fucking work.",
					"Get fucking started.",
					"You have to fucking want it.",
					"No one else fucking knows what they're doing either.",
